...
final uploadProfileImageprovider =
    StateProvider.autoDispose<UploadProfileImageReposetitory>((ref) {
  return UploadProfileImageReposetitory();
});
...
final uploadFilePppp = FutureProvider.autoDispose((ref) async {
  final file = ref.watch(uploadProfileImageprovider).getFile();
  return file;
});

class UploadProfileImageReposetitory {
  //this for text post
